                ...
                <div class="table-responsive">
                  ...
                  <table class="table tablesorter " id="">
                    <tbody class=" text-primary">
                      ...
                      <option value= "24">X TKRO 1</option>
                      <option value= "25">X TKRO 2</option>
                      <option value= "26">X TKRO 3</option>
                      <option value= "27">XI TKRO 1</option>
                      <option value= "28">XI TKRO 2</option>
                      <option value= "29">XI TKRO 3</option>
                      <option value= "30">XII TKRO 1</option>
                      <option value= "31">XII TKRO 2</option>
                      <option value= "32">XII TKRO 3</option>
                      </select>
                        </td>
                      </tr>
